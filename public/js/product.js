        ...
        case 3:
          ...
          if (products.length > 0) {
            products.forEach(function (product, index) {
              var row = "\n                    <tr>\n                        <td>".concat(index + 1, "</td>\n                        <td>").concat(product.product_name, "</td>\n                        <td>").concat(product.product_price, "</td>\n                        <td>").concat(product.product_details, "</td>\n                        <td>\n                            <button class=\"btn btn-sm btn-primary\" onclick=\"editProduct(").concat(product.id, ")\">Edit</button>\n                            <button class=\"btn btn-sm btn-danger\" onclick=\"deleteProduct(").concat(product.id, ")\">Delete</button>\n                        </td>\n                    </tr>");
